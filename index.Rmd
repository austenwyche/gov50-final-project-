...
As we interpret this correlation, it appears that when the gun ownership rate is zero, the number of anticipated deaths is -34.96. This should not be interpreted in a causal manner as it is not possible to have a negative gun ownership rate or a negative number of deaths. 


Furthermore, the correlation displays that for every one unit (one percent) increase in the gun ownership rate, there appears to be a .8890 increase in the number of mass shooting instances. Due to this relationship, it is likely we can conclude the gun ownership rate in the United States has a positive relationship with the number of mass shooting instances. 
...
If there was more time and financial resources to create this study, I would personally document the instances of mass shootings in order to ensure the number is accurate and there is no missing data. In addition, as this study only runs up to 2018, it would be interesting to see the trend in the years up to 2023, when mass shootings have significantly risen in the United States. 
