...
Lastly, it would be interesting to explore if the outcome variable was number of victims rather than mass shooting instances. Instances of mass shootings (say 10 in 2018), conceals the magnitude of these incidents by the number of fatalities. With more time and resources, I would explore the impact of gun ownership rates on this variable. 
