...
In the United States, there is major debate over whether the gun ownership rate makes Americans safer or more vulnerable to danger. By analyzing the relationship between gun ownership and mass shootings, I hope to discover whether there is a relationship between these two very important issues.
...
In addition, it is possible Mother Jones has excluded some instances of mass shootings, resulting in a potential **underreporting** of the true number of instances. The main outcome variable of interest is the number of mass shooting instances, which is seen in the graph below. As we can see, the number of mass shootings documented by Mother Jones has steadily increased in frequency from 2000 to 2018.
...
### Main Relationship of Interest (Gun Ownership Rate and Number of Mass Shooting Instances) {style="color: red"}
