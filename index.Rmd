...
author: "Austen Wyche"
description: "Gun Ownership and Mass Shootings"
output:
...
The main research question is: What is the relationship between gun ownership rates and the number of mass shootings (per year) in the United States? My main hypothesis is that with higher gun ownership, there will be a higher number of mass shootings taking place (I hypothesize there is a positive association between the explanatory and outcome variable). This is important to discover whether there is a correlation between allowing more people to own guns and more instances of violence. 
...
gun_plot <- gun_deaths_by_year %>%
  ...
  labs(title = "Number of Mass Shootings from 2000 to 2018", x = "Year", y = "Number of Mass Shootings")
gun_plot
```
...
As we interpret this correlation, it appears that when the gun ownership rate is zero, the number of anticipated deaths is -34.96. This should not be interpreted in a causal manner as it is not possible to have a negative gun ownership rate or a negative number of deaths. Furthermore, the correlation displays that for every one unit (one percent) increase in the gun ownership rate, there appears to be a .8890 increase in the number of mass shooting instances. Due to this relationship, it is likely we can conclude the gun ownership rate in the United States has a positive relationship with the number of mass shooting instances. 
